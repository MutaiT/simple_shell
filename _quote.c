...
/**
 * quote_state - Gets the state associated with a given character
 * @c: character
 *
...
/**
 * quote_state_f - Gets the function associated with a given state
 * @s: state
 *
 * Return: The state associated with c
 */
...
/**
 * quote_state_len - Gets the length of a given state
 * @str: string
 * @state: state
 *
 * Return: The state associated with c
