...
/**
 * _str_to_list - Turns a string into a linked list (helper)
...
/**
 * add_node - Inserts a string at the beginning of the list
...
/**
 * add_node_end - Adds a string at the end of the list
 * @headptr: a pointer to the address of the first list node
 * @str: the string to add to the list
 * Return: If memory allocation fails, return NULL. Otherwise, return the
 * address of the new no
...
/**
 * free_list - Frees a linked list and and set head to NULL
