...
/**
 * tokenize - Splits a string into words (tokens) and dequote
...
/**
 * count_tokens - Computes the length of a string after dequoting
...
/**
 * tokenize_noquote - Splits a string into words (tokens)
 * @str: the string to tokenize
 * Return: If malloc fails or if str is 0 or contains no tokens, return NULL.
 * Otherwise, return an array containing the tokens in str, terminated by NULL.
 */
...
/**
 * count_tokens_noquote - Counts the words in a string
 * @str: the string to evaluate
